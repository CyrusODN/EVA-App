        ...
        <ScrollView
          ...
          <View
            ...
            <Input
              ...
              borderColor={
                isDark ? themeColors.borderNormal : colors.borderColor
              }
            />
            <Input
          ...
          <Dialog
            ...
            <Dialog.Actions>
              <Button
                ...
                textColor={
                  isDark ? themeColors.textPrimary : colors.darkPrimary
                }>
                {t('common.cancel')}
              </Button>
              <Button
