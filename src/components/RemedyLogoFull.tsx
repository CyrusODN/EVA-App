...
const RemedyLogoFull: React.FC<RemedyLogoFullProps> = ({ width = 200, height = 50, style }) => {
  ...
  return (
    ...
    >
      <G transform="matrix(1,0,0,1,-5776,-4887)">
        <G id="Remedy-AI-Logotype-Gradient" transform="matrix(0.667511,0,0,0.164628,5776.11,4887.65)">
          <Rect x="0" y="0" width="8333.33" height="8333.33" fill="none" />
          <G id="Remedy-AI-Logo-Gradient" transform="matrix(5.37388,0,0,21.7893,-1090.81,-17616.5)">
